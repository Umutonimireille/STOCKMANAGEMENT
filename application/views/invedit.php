...
<body>
  ...
  <form action="" method="post">
   ...
   <div class="form-outline mb-4">
    <input type="number" value=<?php echo $inventory->quantity?> name="quantity" id="form3Example1cg" class="form-control form-control-lg">
    <label class="form-label" for="form3Example1cg">Quantity</label>
 </div>
 <div class="form-outline mb-4">
    <input type="number" value=<?php echo $inventory->productId?> name="pId" id="form3Example4cg" class="form-control form-control-lg">
